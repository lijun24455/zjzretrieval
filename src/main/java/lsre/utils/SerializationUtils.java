...
public class SerializationUtils {
    ...
    /**
     * Create a double[] from an Integer[]<br/>
     * by patch contributed by Franz Graf, franz.graf@gmail.com
     *
     * @param ints the int array
     * @return a new array of doubles
     */
    public static double[] toDoubleArray(ArrayList<Integer> ints) {
        double[] result = new double[ints.size()];
        for (int i = 0; i < result.length; i++) {
            result[i] = Double.valueOf(ints.get(i));
        }
        return result;
    }

    public static double[] doubleListToDoubleArray(ArrayList<Double> list){
